...
/* BOATS */
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until, cancellation_condition)
VALUES('Dalila', 0, 5, 2, 250, 35, 8, '', '', 4, 4.7, '', false, false, '08/08/2021 12:00', '01/01/2022 12:00', 0);
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until, cancellation_condition)
VALUES('Zaklina', 0, 7, 2, 200, 40, 8, '', '', 4, 4.1, '', false, false, '08/08/2021 12:00', '01/01/2022 12:00', 0);
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until, cancellation_condition)
VALUES('Bojana', 1, 7, 2, 300, 40, 8, '', '', 4, 4.1, '', false, true, '08/08/2021 12:00', '01/01/2022 12:00', 1);
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, cancellation_condition)
VALUES('Kristina', 3, 7, 2, 200, 40, 8, '', '', 6, 4.6, '', false, true, 1);
...
/* BOAT RESERVATIONS */
INSERT INTO reservation(BOAT_ID, BOAT_OWNER_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE)
VALUES (1, 4, 5, FALSE, TRUE, '04/11/2021 12:00', '07/11/2021 12:00', FALSE, 'boat_reservation', 4, 25000);
INSERT INTO reservation(BOAT_ID, BOAT_OWNER_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE)
VALUES (3, 4, 5, FALSE, TRUE, '04/04/2021 12:00', '09/04/2021 12:00', FALSE, 'boat_reservation', 6, 20000);

/* BOAT_RESERVATIONS-UPCOMING */
INSERT INTO reservation(BOAT_ID, CLIENT_ID, BOAT_OWNER_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE)
VALUES (1, 5, 4, FALSE, TRUE, '4/11/2022 12:00', '8/11/2022 12:00', FALSE, 'boat_reservation');
INSERT INTO reservation(BOAT_ID, CLIENT_ID, BOAT_OWNER_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE)
VALUES (2, 5, 4, FALSE, TRUE, '4/03/2022 12:00', '8/03/2022 12:00', FALSE, 'boat_reservation');

/* BOAT_RESERVATIONS-PAST*/
INSERT INTO reservation(BOAT_ID, CLIENT_ID, BOAT_OWNER_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE)
VALUES (3, 5, 4, FALSE, TRUE, '04/04/2021 12:00', '09/04/2021 12:00', FALSE, 'boat_reservation', 6, 15000);
INSERT INTO reservation(BOAT_ID, CLIENT_ID, BOAT_OWNER_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE)
VALUES (3, 5, 4, FALSE, TRUE, '05/05/2021 12:00', '09/05/2021 12:00', FALSE, 'boat_reservation', 6, 20000);
INSERT INTO reservation(BOAT_ID, CLIENT_ID, BOAT_OWNER_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE)
VALUES (3, 5, 4, FALSE, TRUE, '04/04/2020 12:00', '09/04/2020 12:00', FALSE, 'boat_reservation', 6, 23000);
