...
/* BOATS */
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until)
VALUES('Dalila', 0, 5, 2, 250, 35, 8, '', '', 4, 4.7, '', false, false, '08/08/2021 12:00', '01/01/2022 12:00');
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until)
VALUES('Zaklina', 0, 7, 2, 200, 40, 8, '', '', 4, 4.1, '', false, false, '08/08/2021 12:00', '01/01/2022 12:00');
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved, available_from, available_until)
VALUES('Bojana', 1, 7, 2, 300, 40, 8, '', '', 4, 4.1, '', false, true, '08/08/2021 12:00', '01/01/2022 12:00');
INSERT INTO BOAT(boat_name, engine_type, length, engine_number, engine_power, max_speed, capacity, rules, description, boat_owner_id, average_rating, image_url, deleted, reserved)
VALUES('Kristina', 3, 7, 2, 200, 40, 8, '', '', 6, 4.6, '', false, true);
