...
VALUES('Rebeka', 6, 4.4, 5, 3000.0, '4/03/2022 12:00', '8/03/2023 12:00');
...
INSERT INTO reservation(COTTAGE_ID, CLIENT_ID, COTTAGE_OWNER_ID, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL,
                        DISCOUNT, NUM_PERSONS, PRICE, RESERVATION_TYPE, START_TIME, END_TIME, RESERVED, DELETED)
VALUES (1, 5, 2, '04/11/2021 10:00', '08/11/2021 10:00', TRUE, 4, 1000, 'cottage_reservation', '05/11/2022 12:00',
        '07/11/2022 12:00', TRUE, FALSE);
...
INSERT INTO reservation(COTTAGE_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE,
                        START_DATE, END_DATE, NUM_PERSONS)
VALUES (2, 5, FALSE, TRUE, '17/01/2022 12:00', '19/01/2022 12:00', FALSE, 'cottage_reservation', '17/01/2022', '19/02/2022', 2);
...
INSERT INTO reservation(BOAT_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, START_DATE,
                        END_DATE, NUM_PERSONS)
...
INSERT INTO reservation(BOAT_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, START_DATE,
                        END_DATE, NUM_PERSONS)
VALUES (2, 5, FALSE, TRUE, '17/01/2022 12:00', '19/01/2022 12:00', FALSE, 'boat_reservation', '17/01/2022', '19/01/2022', 2);
...
INSERT INTO reservation(INSTRUCTOR_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, END_TIME, START_DATE, END_DATE, DISCOUNT, RESERVATION_TYPE)
VALUES (3, 5, FALSE, TRUE, '17/01/2022 12:00', '19/01/2022 12:00', '17/01/2022', '19/01/2022', FALSE, 'instructor_reservation');

/* RESERVATIONS ON DISCOUNT */
INSERT INTO RESERVATION(BOAT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE, NUM_PERSONS,
                        START_DATE, END_DATE, DISCOUNT_PRICE, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL, boat_owner_id)
VALUES (1, FALSE, FALSE, '04/11/2022 12:00', '04/11/2022 20:00', TRUE, 'boat_reservation', 1, 4500, 5, '04/11/2022', '04/11/2022', 3200,
           '04/09/2022 12:00', '04/10/2022 12:00', 4);
INSERT INTO RESERVATION(BOAT_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE, NUM_PERSONS,
                        START_DATE, END_DATE, DISCOUNT_PRICE, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL, boat_owner_id)
...
INSERT INTO RESERVATION(COTTAGE_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE, NUM_PERSONS,
                        START_DATE, END_DATE, DISCOUNT_PRICE, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL)
...
INSERT INTO RESERVATION(INSTRUCTOR_ID, DELETED, RESERVED, START_TIME, END_TIME, DISCOUNT, RESERVATION_TYPE, DURATION, PRICE, NUM_PERSONS,
                        START_DATE, END_DATE, DISCOUNT_PRICE, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL)
VALUES (1, FALSE, FALSE, '04/11/2022 12:00', '04/11/2022 20:00', TRUE, 'instructor_reservation', 1, 7800, 5, '04/11/2022', '04/11/2022', 5800,
        '04/09/2022 12:00', '04/10/2022 12:00');
