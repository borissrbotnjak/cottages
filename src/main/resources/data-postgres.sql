...
INSERT INTO reservation(COTTAGE_ID, CLIENT_ID, COTTAGE_OWNER_ID, DISCOUNT_AVAILABLE_FROM, DISCOUNT_AVAILABLE_UNTIL, DISCOUNT, NUM_PERSONS, PRICE, RESERVATION_TYPE)
VALUES(1, 5, 2, '14/11/2021 10:00', '18/11/2021 10:00', TRUE, 4, 1000, 'cottage_reservation');

/* COTTAGE_RESERVATIONS-PAST */
INSERT INTO reservation(COTTAGE_ID, COTTAGE_OWNER_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, RESERVATION_TYPE)
VALUES(1, 2, 5, FALSE, TRUE, '14/11/2021 12:00', 'cottage_reservation');
INSERT INTO reservation(COTTAGE_ID, COTTAGE_OWNER_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, RESERVATION_TYPE)
VALUES(3, 3, 5, FALSE, TRUE, '14/11/2021 12:00', 'cottage_reservation');

/* COTTAGE_RESERVATIONS-UPCOMING */
INSERT INTO reservation(COTTAGE_ID, COTTAGE_OWNER_ID, CLIENT_ID, DELETED, RESERVED, START_TIME, RESERVATION_TYPE)
VALUES(1, 2, 5, FALSE, TRUE, '15/11/2022 12:00', 'cottage_reservation');
